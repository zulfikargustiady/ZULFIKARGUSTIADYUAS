          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <a href="index.php?menu=14" class="btn btn-danger print">Cetak PDF</a>
                <a href="pages/admin/pinjam/excel.php" class="btn btn-danger ">Cetak Excel</a>
                <a href="index.php?menu=11" type="btn" class="btn btn-primary">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $query = mysqli_query($koneksi, "SELECT *, user.nama AS nam, tbl_buku.judul AS jud
                FROM tbl_peminjaman
                ...
                ");
                    ...
                    while ($row = mysqli_fetch_assoc($query)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <a data-toggle="modal" data-target="#kembali<?php echo $id_peminjaman; ?>"
                            class="btn btn-warning">
                            <i class="fas fa-undo"></i> Kembali
                          </a>
                          <a data-toggle="modal" data-target="#hapus<?php echo $id_peminjaman; ?>" class="btn btn-danger">
                            ...
                            <div class="modal-body">
                              <form action="pages/admin/pinjam/hapus.php" method="POST">
                                <div class="form-group">
                                  <input type="hidden" class="form-control" name="id" value="<?= $id_peminjaman; ?>">
                                  <p>
                      ...
                      <div class="modal fade" id="kembali<?php echo $id_peminjaman; ?>">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form role="form" action="pages/admin/pinjam/kembali.php" method="post">
                                <div class="card-body">
                                  <div class="form-group">
                                    ...
                                    <p>Apakah Anda yakin mau melakukan proses pengembalian atas nama <b>
                                        <?php echo $id_user ?>
                                      </b> ?</p>
                                  </div>
                                  <!-- /.card-body -->
