        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <a href="index.php?menu=5" type="btn" class="btn btn-primary">
              ...
              <tbody>
                ...
                while ($row=mysqli_fetch_assoc($query)) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a type="btn" class="btn btn-warning" href="index.php?menu=9&id=<?= $id; ?>">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <a data-toggle="modal" data-target="#hapus<?php echo $id; ?>" class="btn btn-danger">
                        <i class="fas fa-trash-alt"></i> Hapus
                      </a>
                      <a  type="btn" class="btn btn-info" href="index.php?menu=8&id=<?= $id; ?>">
                          ...
                          <div class="modal-body">
                            <form action="pages/admin/buku/hapus.php" method="POST">
                              <div class="form-group">
                                ...
                                <p>
                                  <b>Apakah anda yakin akan menghapus Buku <?= $judul; ?></b>?
                                </p>
                              </div>
